...
class Email{
    ...
    static welcomeEmail(user,password){
      ...
      return {
          ...
          <div>
          <h3 style="color: #FFAF00; margin-left: 20px; font-weight: 900;">Welcome to Your School System</h3>
          </div>
          </div>
          ...
          <p>Hi ${user.email}, here it is your current password .........${password}........... you can change it if you want  </p>
